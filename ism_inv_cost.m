...
% C1 = (1/pp.x)*in_u.*(gg.dh_x*(pp.bd*alpha));                   %gradient of alpha coefficients, x-dir/ugrid
% 
% 
...
% C2 = (1/pp.x)*in_v.*(gg.dh_y*(pp.bd*alpha));                    %gradient of alpha coefficients, y-dir/vgrid
% 
